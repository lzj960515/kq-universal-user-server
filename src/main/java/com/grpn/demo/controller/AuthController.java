...
public class AuthController {
    ...
    */
    ...
    @PostMapping
    public BaseResult<Void> create(@Valid @RequestBody Auth domain) {
        // 业务逻辑
    ...
    */
    ...
    @PutMapping
    public BaseResult<Void> update(@Valid @RequestBody Auth domain) {
        // 业务逻辑
    ...
    */
    ...
    @GetMapping("/{id}")
    public BaseResult<Auth> get(@PathVariable Long id) {
        Auth domain = service.get(id);
    ...
    */
    ...
    @GetMapping
    public BaseResult<PageBean<Auth>> page(@RequestParam(defaultValue = "1") int pageNum, @RequestParam(defaultValue = "10") int numPerPage, @YapiParameterObject Auth domain) {
        IPage<Auth> page = service.page(pageNum, numPerPage, domain);
